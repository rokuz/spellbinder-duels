...
public class Spell 
{
  ...
  public enum Type
  {
    ...
    METEORITE, ICE_RAIN, STORM, DARKNESS_SHIELD, BLOOD_SIGN, POISONING, PHANTOM, WILD_VINE, ASTRAL_PROJECTION,
    INFERNO, ICE_FETTERS, TORNADO, VAMPIRE, SOUL_ABRUPTION, BURNING_SHIELD, HYPNOSIS
  }
