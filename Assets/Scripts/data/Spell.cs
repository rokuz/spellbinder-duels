...
public class Spell 
{
  ...
  {
    NO_SPELL,
    FIREBALL, ICE_SPEAR, LIGHTNING, BLINDNESS, BLEEDING, STONESKIN, DOPPELGANGER, NATURE_CALL, BLESSING,
    //FIRE_STORM, METEORITE, BURNING_SHIELD, FATAL_BURN, FIRE_RING, INVISIBLE_FIRE, WILDFIRE, DIVINE_FIRE
  }
